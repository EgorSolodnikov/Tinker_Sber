...
bool hardware_msg__msg__motor_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("hardware_msg.msg._motor_data.MotorData", full_classname_dest, 38) == 0);
  }
  hardware_msg__msg__MotorData * ros_message = _ros_message;
  {  // id
  ...
  {  // motor_connected
    PyObject * field = PyObject_GetAttrString(_pymsg, "motor_connected");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->motor_connected = (Py_True == field);
    Py_DECREF(field);
  }
  {  // ready
...
PyObject * hardware_msg__msg__motor_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("hardware_msg.msg._motor_data");
  ...
  {  // motor_connected
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->motor_connected ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "motor_connected", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
