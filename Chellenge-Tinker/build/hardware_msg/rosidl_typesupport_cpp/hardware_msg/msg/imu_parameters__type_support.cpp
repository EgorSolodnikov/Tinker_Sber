...
static const _ImuParameters_type_support_symbol_names_t _ImuParameters_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hardware_msg, msg, ImuParameters)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, hardware_msg, msg, ImuParameters)),
  }
};
...
{
  return &::hardware_msg::msg::rosidl_typesupport_cpp::ImuParameters_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, hardware_msg, msg, ImuParameters)() {
  return get_message_type_support_handle<hardware_msg::msg::ImuParameters>();
}
