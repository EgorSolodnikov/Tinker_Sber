...
#include "hardware_msg/msg/detail/motor_data__rosidl_typesupport_fastrtps_c.h"
...
using _MotorData__ros_msg_type = hardware_msg__msg__MotorData;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_hardware_msg
bool cdr_serialize_hardware_msg__msg__MotorData(
  const hardware_msg__msg__MotorData * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_hardware_msg
bool cdr_deserialize_hardware_msg__msg__MotorData(
  eprosima::fastcdr::Cdr & cdr,
  hardware_msg__msg__MotorData * ros_message)
{
  // Field name: id
  {
    cdr >> ros_message->id;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_hardware_msg
size_t get_serialized_size_hardware_msg__msg__MotorData(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_hardware_msg
size_t max_serialized_size_hardware_msg__msg__MotorData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = hardware_msg__msg__MotorData;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_hardware_msg
bool cdr_serialize_key_hardware_msg__msg__MotorData(
  const hardware_msg__msg__MotorData * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: id
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_hardware_msg
size_t get_serialized_size_key_hardware_msg__msg__MotorData(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MotorData__ros_msg_type * ros_message = static_cast<const _MotorData__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_hardware_msg
size_t max_serialized_size_key_hardware_msg__msg__MotorData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const hardware_msg__msg__MotorData * ros_message = static_cast<const hardware_msg__msg__MotorData *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_hardware_msg__msg__MotorData(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  hardware_msg__msg__MotorData * ros_message = static_cast<hardware_msg__msg__MotorData *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_hardware_msg__msg__MotorData(cdr, ros_message);
}

static uint32_t _MotorData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_hardware_msg__msg__MotorData(
...
static size_t _MotorData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_hardware_msg__msg__MotorData(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hardware_msg, msg, MotorData)() {
