...
class MotorData(metaclass=Metaclass_MotorData):
    ...
    def __init__(self, **kwargs):
        ...
        self.motor_connected = kwargs.get('motor_connected', bool())
    ...
    def __eq__(self, other):
        ...
        if self.connect != other.connect:
            return False
        if self.motor_connected != other.motor_connected:
            return False
    ...
    def motor_connected(self):
        """Message field 'motor_connected'."""
        return self._motor_connected

    @motor_connected.setter
    def motor_connected(self, value):
        if self._check_fields:
            assert \
                isinstance(value, bool), \
                "The 'motor_connected' field must be of type 'bool'"
        self._motor_connected = value
