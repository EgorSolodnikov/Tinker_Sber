...
{
  new (message_memory) hardware_msg::msg::Imu(_init);
}

void Imu_fini_function(void * message_memory)
{
  auto typed_message = static_cast<hardware_msg::msg::Imu *>(message_memory);
  typed_message->~Imu();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Imu_message_member_array[3] = {
  {
    ...
    offsetof(hardware_msg::msg::Imu, pitch),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(hardware_msg::msg::Imu, roll),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(hardware_msg::msg::Imu, yaw),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
get_message_type_support_handle<hardware_msg::msg::Imu>()
{
  return &::hardware_msg::msg::rosidl_typesupport_introspection_cpp::Imu_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, hardware_msg, msg, Imu)() {
  return &::hardware_msg::msg::rosidl_typesupport_introspection_cpp::Imu_message_type_support_handle;
}
